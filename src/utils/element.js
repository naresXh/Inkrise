...
/* This function that is nothing but create a path for brush all 
element and make path in the form of string */
...
export const isPointerNearElement = (element, pointX, pointY) => {
  ...
  switch (type) {
    ...
    default:
      throw new Error("Type is not Recongnized");
  }
};
